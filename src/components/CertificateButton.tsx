...
export function CertificateButton({ studentName, courseName, teacherName }: CertificateButtonProps) {
  const generateCertificate = () => {
    ...
    doc.setFontSize(16);
    doc.setTextColor("#1A3C34");
    doc.text("Dr. Jehan Ali Ziad", 550, 470, { align: "center" });
    doc.setDrawColor("#D4AF37");
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-2 rounded-full bg-amber-500 px-6 py-3 text-sm font-semibold text-gray-900 hover:bg-amber-400 transition"
    >
      <Award size={18} />
