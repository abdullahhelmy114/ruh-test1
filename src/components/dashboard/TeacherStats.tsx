      ...
      <div className="lg:col-span-3 rounded-3xl border bg-card p-6 shadow-elegant">
        <div className="mb-5 flex flex-wrap items-end justify-between gap-3">
          ...
          <div className="text-sm text-gray-500">
            <span className="text-gray-900 font-semibold">{referrals}</span> / {target} referrals
          </div>
        </div>
        ...
        <div className="mt-6 flex flex-col gap-3 rounded-2xl border bg-background p-4 sm:flex-row sm:items-center">
          <div className="text-xs uppercase tracking-widest text-gray-500 sm:flex-none">Your link</div>
          <code className="flex-1 truncate rounded-full bg-muted px-4 py-2 text-sm">ruhulqudus.academy/r/dr-jehan-7f2a</code>
          <button className="inline-flex items-center justify-center gap-2 rounded-full gradient-primary px-4 py-2 text-xs font-semibold text-primary-foreground">
            <Copy className="h-3.5 w-3.5" /> Copy
          </button>
        </div>

        <div className="mt-6">
          <div className="mb-3 text-xs font-semibold uppercase tracking-widest text-gray-500">Recent Referrals</div>
            ...
            {[
              ...
              <div key={r.name} className="flex items-center justify-between px-4 py-3 text-sm">
                <div className="flex items-center gap-3">
                  <div className="grid h-8 w-8 place-items-center rounded-full gradient-primary text-xs text-primary-foreground">
                    {r.name[0]}
                  </div>
  ...
  return (
    <div className="rounded-3xl border bg-card p-6 shadow-elegant">
      <div className="flex items-center justify-between">
        ...
        <div className="grid h-8 w-8 place-items-center rounded-full bg-amber-100text-amber-700">{icon}</div>
      </div>
