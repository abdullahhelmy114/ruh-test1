      ...
      <section className="mx-auto max-w-5xl px-4 py-16 md:px-8">
        <div className="space-y-8">
          {sections.map(({ key, icon: Icon }, index) => (
            <div
              key={key}
              className="glass rounded-3xl border border-gray-200/50 bg-card p-6 md:p-8 shadow-sm transition-all hover:-translate-y-1 hover:shadow-xl hover:shadow-primary/10"
            >
