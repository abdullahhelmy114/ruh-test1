...
// 🛑 تم إخفاء المعلمين: حذف عنصر Teachers من قائمة الميزات
const features = [
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 md:px-8">
        <div className="grid gap-8 md:grid-cols-2">
          <div className="group glass rounded-3xl border border-gray-200/50 bg-card p-8 shadow-elegant transition-all hover:-translate-y-1 hover:shadow-2xl hover:shadow-primary/10">
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 md:px-8">
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {features.map(({ key, icon: Icon }) => (
            <div
              key={key}
              className="group glass rounded-3xl border border-gray-200/50 bg-card p-6 shadow-sm transition-all hover:-translate-y-1 hover:shadow-2xl hover:shadow-primary/10"
            >
              <div className="grid h-12 w-12 place-items-center rounded-2xl bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600 group-hover:scale-110 transition-transform">
      ...
      <section className="mx-auto max-w-5xl px-4 py-16 md:px-8">
        <div className="glass relative overflow-hidden rounded-3xl border border-gray-200/50 bg-card p-8 md:p-12 shadow-elegant">
          ...
          <div className="relative z-10">
            ...
            <h2 className="mt-4 font-serif text-3xl font-semibold text-gray-900">
              <T>Founder Name</T>
            </h2>
