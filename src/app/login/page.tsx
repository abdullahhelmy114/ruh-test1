      ...
      <div className="grid min-h-[calc(100vh-4rem)] place-items-center bg-background px-4 py-12">
        ...
        >
          ...
          <button
            ...
            className="rounded-full bg-emerald-600 text-white px-6 py-2 text-sm font-semibold hover:bg-emerald-700 transition"
          >
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <p className="text-center text-xs text-gray-500">
              ...
              <Link href="/signup" className="text-amber-700 underline-offset-4 hover:underline"><T>Create one</T></Link>
            </p>
          </form>
        </motion.div>
      </div>
