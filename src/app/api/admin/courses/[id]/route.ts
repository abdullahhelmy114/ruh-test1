...
export async function PUT(req: Request, { params }: { params: { id: string } }) {
  ...
  await sql`
    UPDATE courses
    SET category_id=${category_id}, title=${title}, description=${description}, intro_video_url=${intro_video_url},
        price=${price}, launch_date=${launch_date}, course_duration=${course_duration},
        lesson_duration=${lesson_duration}, instructor_name=${instructor_name}, theme=${theme},
