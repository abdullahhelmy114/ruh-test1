    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 md:px-8">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {[
            ...
            <div
              key={item.step}
              className="glass rounded-3xl border border-gray-200/50 bg-card p-8 text-center shadow-sm transition-all hover:-translate-y-1 hover:shadow-xl hover:shadow-primary/10"
            >
          ...
          <div className="relative z-10">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {[
                ...
                <div key={item.key} className="flex items-start gap-3 bg-white/50 rounded-2xl p-4 border border-gray-200/50">
                  <CheckCircle size={20} className="text-emerald-500 mt-0.5 shrink-0" />
                  <div>
                    <h4 className="text-sm font-semibold text-gray-900"><T>{item.key}</T></h4>
      ...
      {user ? (
        <section className="mx-auto max-w-3xl px-4 py-16 md:px-8">
          <div className="glass rounded-3xl border border-gray-200/50 bg-card p-8 text-center shadow-elegant">
            ...
            <div className="mt-6 flex items-center justify-center gap-3">
              <code className="rounded-full border border-gray-200 bg-background px-5 py-2.5 text-sm font-mono">
                {referralLink}
              </code>
              <button
                onClick={copyLink}
                className="inline-flex items-center justify-center rounded-full bg-amber-500 p-2.5 text-black hover:bg-amber-500/90 transition"
                title="Copy link"
              >
        ...
        /* ========== CTA for non‑authenticated users (تم حذف زر المعلم) ========== */
          ...
          <div className="space-y-4">
            {[
              ...
              <details key={i} className="group">
                <summary className="flex cursor-pointer items-center justify-between rounded-2xl bg-white/50 px-5 py-4 text-sm font-medium text-gray-900">
                  <T>{faq.q}</T>
