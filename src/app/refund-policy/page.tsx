...
import { RefreshCw, FileText, ShieldAlert, HelpCircle, Mail } from "lucide-react";
import { T } from "@/components/TranslatedText";

export const metadata: Metadata = {
  title: "Refund Policy | Ruh-Ul-Qudus Academy",
  alternates: { canonical: "https://ruhulqudus.com" },
};

const refundSections = [
  { key: "Refund General", icon: FileText },
  { key: "Refund Law", icon: ShieldAlert },
  { key: "Refund Exceptions", icon: HelpCircle },
  { key: "Refund Support", icon: Mail },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="mx-auto max-w-5xl px-4 pb-24 md:px-8">
        <div className="space-y-8">
          {refundSections.map(({ key, icon: Icon }, index) => (
