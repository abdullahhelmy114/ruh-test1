...
export default function AdminModelLessonsPage() {
  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      try {
        ...
        const res = await fetch(`/api/admin/model-course/${modelId}/lessons`, {
  ...
  const handleReorder = (reordered: ModelLesson[]) => {
    ...
    tokenPromise.then(token =>
      fetch(`/api/admin/model-course/${modelId}/lessons/reorder`, {
        method: "PUT",
        credentials: "include",
        headers: {
          "Content-Type": "application/json",
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-6 space-y-6">
      ...
      <Button
        variant="ghost"
        onClick={() => router.push("/dashboard/admin/model-course")}
